...
serializeBlockedSite = function serializeBlockedSite(blockedSite) {
    return JSON.stringify(blockedSite);
};

//Private to this and blocked_site_list
parseBlockedSite = function parseBlockedSite(blockedSite) {
...
//Private to this and storage.js
deserializeBlockedSite = function deserializeBlockedSite(serializedBlockedSite) {
