...
serializeBlockedSiteList = function serializeBlockedSiteList(blockedSiteList) {
    return JSON.stringify(blockedSiteList);
};

//Private method
parseBlockedSiteList = function parseBlockedSiteList(blockedSiteList) {
...
//Private to this and storage.js
deserializeBlockedSiteList = function deserializeBlockedSiteList(serializedBlockedSiteList) {
